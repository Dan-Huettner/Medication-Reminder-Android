...
public class RemovePatientDialog extends Dialog implements
    ...
    public RemovePatientDialog(Activity a) {
        super(a);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.remove_btn_yes:
                ((MainActivity) c).removePatientDialogOnOkCallback();
                break;
            case R.id.remove_btn_no:
                ((MainActivity) c).removePatientDialogOnCancelCallback();
                dismiss();
                break;
            default:
                break;
